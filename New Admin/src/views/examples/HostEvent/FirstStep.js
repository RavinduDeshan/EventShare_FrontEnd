...
export default function FirstStep(props) {
  ...
  const [category, setCat] = useState(userFData.category?userFData.category:"");
  ...
  return (
    <React.Fragment>
     ...
     <Form>
                    ...
                    <Row>
                      <Col lg="6">
                        <FormGroup>
                          ...
                          </label> {nameError && <Badge style={{marginLeft:"10px"}} color="warning">Please Enter the Company Name</Badge>}
                          <Input
                      ...
                      <Col lg="6">
                        <FormGroup>
                          ...
                          >
                           Company Category
                          </label>   {categoryError && <Badge style={{marginLeft:"10px"}} color="warning">Please Select a Company Category</Badge>}
                          <Input
                            className="form-control-alternative"
                            id="input-email"
                            ...
                            value={category}
                            onChange={(e)=>{setCat(e.target.value); categorysetError('') }}
                            type="select"
                          >
                                        <option value="Entertainment">Entertainment</option>
                                        <option value="Media">Media</option>
                                        <option value="Government">Government</option>
                                        <option value="School Society / Association">School Society / Association</option>
                    ...
                    <Row>
                      <Col lg="6">
                        <FormGroup>
                          ...
                          >
                           Your NIC
                          </label>   {nicError && <Badge style={{marginLeft:"10px"}} color="warning">{nicError}</Badge>}
                          <Input
                            className="form-control-alternative"
                            id="input-username"
                            placeholder="Event Hosting Organization"
                            ...
                            value={nic}
                            onChange={(e)=>{setNIC(e.target.value); nicsetError('') }}
                          />
                        </FormGroup>
                      </Col>
                      <Col lg="6">
                        <FormGroup>
                          ...
                          >
                           Your Role
                          </label>  {roleError && <Badge style={{marginLeft:"10px"}} color="warning">Please Select your role</Badge>}
                          <Input
                            className="form-control-alternative"
                            id="input-email"
                            ...
                            value={role}
                            onChange={(e)=>{setRole(e.target.value); rolesetError('')}}
                            type="select"
                          >
                  ...
                  <div className="pl-lg-4">
                    <FormGroup>
                      <label>Company Description</label> {noteError && <Badge style={{marginLeft:"10px"}} color="warning">This field can not be empty</Badge>}
                      <Input
                        className="form-control-alternative"
                        ...
                        value={note}
                        onChange={(e)=>{setNote(e.target.value); notesetNameError('')}}
                      />
