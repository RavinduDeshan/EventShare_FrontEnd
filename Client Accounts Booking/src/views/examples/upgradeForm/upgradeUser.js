...
function getStepContent(step) {
  ...
  <div className={classes.paper}>
      ...
      <main className={classes.layout}>
        ...
        <center>  <a class="navbar-brand"><img style={{width:"300px"}} src="https://res.cloudinary.com/fashionistaimage/image/upload/v1618838914/eventsharelogo2_lgqslw.png"/> </a></center>
